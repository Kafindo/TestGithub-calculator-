...
if __name__ == "__main__":
    ...
    button1 = Button(gui, text=' 1 ', fg='black', bg='red', command=lambda: press(2), height=1, width=7 )
    ...
    division = Button(gui, text=' / ', fg='black', bg='red', command=lambda: press(" / "), height=1, width=7 )
    division.grid(row=5, column=3)

    equal = Button(gui, text=' = ', fg='black', bg='red', command=equalpress, height=1, width=7 )
    equal.grid(row=5, column=2)

    clear = Button(gui, text=' 1 ', fg='black', bg='red', command=clear, height=1, width=7 )
